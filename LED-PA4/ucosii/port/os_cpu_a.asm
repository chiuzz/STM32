...
;NVIC_SYSPRI14   EQU     0xE000ED20;0xE000ED22                              ; System priority register (priority 14).
...
;PendSV_Handler
    ...
    ;LDR     R1, =OSTCBCur                                    ; OSTCBCurPtr->OSTCBStkPtr = SP;
    ;LDR     R1, [R1]
    ;STR     R0, [R1]                                            ; R0 is SP of process being switched out
...
;OS_CPU_PendSVHandler_nosave
    ...
    ;LDR     R0, =OSTCBCur                                    ; OSTCBCurPtr = OSTCBHighRdyPtr;
    ;LDR     R1, =OSTCBHighRdy
    ;LDR     R2, [R1]
    ;STR     R2, [R0]
